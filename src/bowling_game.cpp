...
{
    static constexpr std::size_t kSzDisplayWidth = 80U;
    static constexpr std::int32_t kI32FieldWidth = 8;

    std::cout << "\n"
              << std::string(kSzDisplayWidth, '=') << std::endl;
    std::cout << "BOWLING SCORECARD - Player: " << str_player_name_ << std::endl;
    std::cout << std::string(kSzDisplayWidth, '=') << std::endl;
